...
public interface CompressedXmlParserListener {
     ...
     * @param localName the local name (without prefix), or the empty string if the name is not
     *                  available
     * @param qName     the qualified name (with prefix), or the empty string if qualified names are
     *                  not available
     * @param atts      the attributes attached to the element. If there are no attributes, it shall
     *                  be an empty array.
     */
