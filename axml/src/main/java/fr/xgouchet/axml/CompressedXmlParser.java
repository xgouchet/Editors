...
public class CompressedXmlParser {
     ...
     * @throws java.io.IOException if the input can't be read
     */
     ...
     * @throws java.io.IOException                            if the input can't be read
     * @throws javax.xml.parsers.ParserConfigurationException if a DocumentBuilder can't be created
     */
...
//        mParserOffset += chunk;
     ...
     * <ul>
     * <li>0 : 0x00100100 = Start NS / 0x00100101 = end NS</li>
     * <li>1 : chunk size</li>
     * <li>2 : line this tag appeared</li>
     * <li>3 : ??? (always 0xFFFFFF)</li>
     * <li>4 : index of namespace prefix in StringIndexTable</li>
...
//        mParserOffset += (6 * WORD_SIZE);
     ...
     * <ul>
     * <li>0 : 0x00100102 = Start_Tag</li>
     * <li>1 : chunk size</li>
     * <li>2 : line this tag appeared in the original file</li>
     * <li>3 : ??? (always 0xFFFFFF)</li>
     * <li>4 : index of namespace uri in StringIndexTable, or 0xFFFFFFFF
     * for default NS</li>
     * <li>5 : index of element name in StringIndexTable</li>
     * <li>6 : ???</li>
     * <li>7 : number of attributes following the start tag</li>
     * <li>8 : ??? (0)</li>
     * </ul>
     */
    @Deprecated
...
//        mListener.startElement(uri, name, qname, attrs);
     ...
     * <ul>
     * <li>0 : index of namespace uri in StringIndexTable, or 0xFFFFFFFF
     * for default NS</li>
     * <li>1 : index of attribute name in StringIndexTable</li>
     * <li>2 : index of attribute value, or 0xFFFFFFFF if value is a
     * typed value</li>
     * <li>3 : value type</li>
...
//        return attr;
     ...
     * <ul>
     * <li>0 : 0x00100104 = Text</li>
     * <li>1 : chunk size</li>
     * <li>2 : line this element appeared in the original document</li>
...
//        mParserOffset += (7 * WORD_SIZE);
     ...
     * <ul>
     * <li>0 : 0x00100103 = End_Tag</li>
     * <li>1 : chunk size</li>
     * <li>2 : line this tag appeared in the original file</li>
     * <li>3 : ??? (always 0xFFFFFFFF)</li>
     * <li>4 : index of namespace name in StringIndexTable, or 0xFFFFFFFF
     * for default NS</li>
     * <li>5 : index of element name in StringIndexTable</li>
     * </ul>
     */
